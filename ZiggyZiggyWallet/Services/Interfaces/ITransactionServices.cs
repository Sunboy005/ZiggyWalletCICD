...
namespace ZiggyZiggyWallet.Services.Interfaces
{
    public interface ITransactionServices
    {
        ...
        Task<TransactionToAdd> AdminTopUp(float amount, string currencyId, string wallId);
        Task<TransactionToAdd> CardTopUp(float amount, string currencyId, string wallId, string cardNo, int ccv, int yearOfExp, string pin);
