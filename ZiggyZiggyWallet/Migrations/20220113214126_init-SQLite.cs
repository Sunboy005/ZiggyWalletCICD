        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Abbrevation = table.Column<string>(maxLength: 3, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<string>(nullable: true),
                    UpdatedAt = table.Column<string>(nullable: true),
                    AmountSent = table.Column<float>(nullable: false),
                    AmountReceived = table.Column<float>(nullable: false),
                    Description = table.Column<string>(nullable: true),
                    SenderCurrency = table.Column<string>(nullable: true),
                    RecieverCurrency = table.Column<string>(nullable: true),
                    SenderWalletId = table.Column<string>(nullable: false),
                    RecipientWalletId = table.Column<string>(nullable: false),
                    Status = table.Column<string>(nullable: true),
                    TranxType = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
